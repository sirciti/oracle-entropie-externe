...
- Name: Oracle d'Entropie Front-End >> Données d'entropie et génération
- Location: G:\oracle-entropie-externe\frontend\tests\icosahedron.spec.js:59:5
...
Received string:  "Erreur"
    at G:\oracle-entropie-externe\frontend\tests\icosahedron.spec.js:72:40
```
