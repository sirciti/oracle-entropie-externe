...
- Name: Oracle d'Entropie Front-End >> Erreur lors de la récupération des données de l'API
- Location: G:\oracle-entropie-externe\frontend\tests\icosahedron.spec.js:82:5
